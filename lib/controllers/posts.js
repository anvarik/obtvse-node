...
this.index = function(req, res, next) {
    storage.getPublishedPosts(function(posts) {
        console.log('posts.index is called');
        ...
        console.log('posts.index ' + articleCount + ' posts have been found');
        var postsTmp = posts;
...
this.save = function(req, res, next) {
    ...
    console.log('called posts.save ');
    console.log("req.param('draft'): " + req.param('draft'));
    storage.add(obj);
    res.redirect('/admin/');
};